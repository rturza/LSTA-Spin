/*** Generated by Spin Version 6.5.1 -- 20 December 2019 ***/
/*** From source: project.pml ***/
...
{	int j = 0, h = now._nr_pr;
	...
	case 1:	/* Login */
		...
		((P1 *)pptr(h))->recbit = 0;
#ifdef VAR_RANGES
		logval("Login:recbit", ((P1 *)pptr(h))->recbit);
#endif
#ifdef HAS_CODE
		locinit1(h);
#endif
	...
	case 0:	/* User */
		...
		((P0 *)pptr(h))->recbit = 0;
#ifdef VAR_RANGES
		logval("User:sndbit", ((P0 *)pptr(h))->sndbit);
		logval("User:recbit", ((P0 *)pptr(h))->recbit);
#endif
#ifdef HAS_CODE
		locinit0(h);
#endif
...
{
		now.toU = addqueue(calling_pid, 1, 0);
		now.toL = addqueue(calling_pid, 2, 0);
#ifdef VAR_RANGES
#endif
}
...
#endif
	switch (n) {
	case 2: j = sizeof(Q2); q_flds[2] = 2; q_max[2] = 2; break;
	case 1: j = sizeof(Q1); q_flds[1] = 2; q_max[1] = 2; break;
...
{	int i = 0;
	...
	{	if (t->ty[i] == TIMEOUT_F) return 1;
		...
		switch (t->qu[i]) {
		case 0: break;
		case 1: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( now.toU) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( now.toU) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( now.toU) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( now.toU) )))
			    ) return 0; break;
		case 2: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( now.toL) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( now.toL) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( now.toL) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( now.toL) )))
			    ) return 0; break;
		case 3: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P0 *)_this)->in) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P0 *)_this)->in) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P0 *)_this)->in) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P0 *)_this)->in) )))
			    ) return 0; break;
		case 4: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P0 *)_this)->out) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P0 *)_this)->out) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P0 *)_this)->out) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P0 *)_this)->out) )))
			    ) return 0; break;
		case 5: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)_this)->in) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)_this)->in) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)_this)->in) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)_this)->in) )))
			    ) return 0; break;
		case 6: if (	(t->ty[i] == Q_FULL_F && ( q_full((int) ( ((P1 *)_this)->out) )))
			 || 	(t->ty[i] == Q_FULL_T && (!q_full((int) ( ((P1 *)_this)->out) )))
			 || 	(t->ty[i] == Q_EMPT_F && ( !q_len((int) ( ((P1 *)_this)->out) )))
			 || 	(t->ty[i] == Q_EMPT_T && (  q_len((int) ( ((P1 *)_this)->out) )))
			    ) return 0; break;
...
{	/* int i; */
	printf("global vars:\n");
	printf("	mtype  req2log:	2\n");
	printf("	mtype  dis_log_pg:	1\n");
	printf("	chan toU (=%d):	len %d:\t", now.toU, q_len(now.toU));
	c_chandump(now.toU);
	printf("	chan toL (=%d):	len %d:\t", now.toL, q_len(now.toL));
	c_chandump(now.toL);
}
void
...
{	/* int i; */
	...
	case 2:
		...
		break;
	case 1:
		printf("local vars proc %d (Login):\n", pid);
	printf("	chan in (=%d):	len %d:\t", ((P1 *)pptr(pid))->in, q_len(((P1 *)pptr(pid))->in));
	c_chandump(((P1 *)pptr(pid))->in);
	printf("	chan out (=%d):	len %d:\t", ((P1 *)pptr(pid))->out, q_len(((P1 *)pptr(pid))->out));
	c_chandump(((P1 *)pptr(pid))->out);
	printf("	bit    recbit:	%d\n", ((P1 *)pptr(pid))->recbit);
		break;
	case 0:
		printf("local vars proc %d (User):\n", pid);
	printf("	chan in (=%d):	len %d:\t", ((P0 *)pptr(pid))->in, q_len(((P0 *)pptr(pid))->in));
	c_chandump(((P0 *)pptr(pid))->in);
	printf("	chan out (=%d):	len %d:\t", ((P0 *)pptr(pid))->out, q_len(((P0 *)pptr(pid))->out));
	c_chandump(((P0 *)pptr(pid))->out);
	printf("	bit    sndbit:	%d\n", ((P0 *)pptr(pid))->sndbit);
	printf("	bit    recbit:	%d\n", ((P0 *)pptr(pid))->recbit);
		break;
	}
...
printm(int x, char *s)
{
	...
	switch (x) {
	case 1: Printf("dis_log_pg"); return;
	case 2: Printf("req2log"); return;
