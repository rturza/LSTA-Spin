...
#define _nstates1	7	/* Login */
#define minseq1	6
#define maxseq1	11
#define _endstate1	6

#define _nstates0	7	/* User */
#define minseq0	0
#define maxseq0	5
#define _endstate0	6
...
#define PLogin	((P1 *)_this)
typedef struct P1 { /* Login */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 4; /* state    */
#ifdef HAS_PRIORITY
...
#define Air1	(sizeof(P1) - Offsetof(P1, out) - 1*sizeof(uchar))

#define PUser	((P0 *)_this)
typedef struct P0 { /* User */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 4; /* state    */
#ifdef HAS_PRIORITY
